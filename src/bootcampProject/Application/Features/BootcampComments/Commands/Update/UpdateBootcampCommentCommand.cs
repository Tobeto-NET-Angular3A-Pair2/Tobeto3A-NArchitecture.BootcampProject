...
public class UpdateBootcampCommentCommand : IRequest<UpdatedBootcampCommentResponse>, ISecuredRequest, ILoggableRequest, ITransactionalRequest
{
    ...
    public class UpdateBootcampCommentCommandHandler : IRequestHandler<UpdateBootcampCommentCommand, UpdatedBootcampCommentResponse>
    {
        ...
        public UpdateBootcampCommentCommandHandler(IMapper mapper, IBootcampCommentRepository bootcampCommentRepository,
        ...
        public async Task<UpdatedBootcampCommentResponse> Handle(UpdateBootcampCommentCommand request, CancellationToken cancellationToken)
        {
