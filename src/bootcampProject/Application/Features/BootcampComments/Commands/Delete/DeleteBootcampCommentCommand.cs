...
public class DeleteBootcampCommentCommand
    : IRequest<DeletedBootcampCommentResponse>,
        ISecuredRequest,
        ILoggableRequest,
        ITransactionalRequest
{
    ...
    public class DeleteBootcampCommentCommandHandler
        : IRequestHandler<DeleteBootcampCommentCommand, DeletedBootcampCommentResponse>
    {
        ...
        public DeleteBootcampCommentCommandHandler(
            IMapper mapper,
        ...
        public async Task<DeletedBootcampCommentResponse> Handle(
            DeleteBootcampCommentCommand request,
