...
public class GetListBootcampCommentQuery : IRequest<GetListResponse<GetListBootcampCommentListItemDto>>, ISecuredRequest
{
    ...
    public class GetListBootcampCommentQueryHandler
        : IRequestHandler<GetListBootcampCommentQuery, GetListResponse<GetListBootcampCommentListItemDto>>
    {
        ...
        public async Task<GetListResponse<GetListBootcampCommentListItemDto>> Handle(
            GetListBootcampCommentQuery request,
        ...
        )
        {
            ...
            GetListResponse<GetListBootcampCommentListItemDto> response = _mapper.Map<
                GetListResponse<GetListBootcampCommentListItemDto>
            >(bootcampComments);
            return response;
        }
    }
