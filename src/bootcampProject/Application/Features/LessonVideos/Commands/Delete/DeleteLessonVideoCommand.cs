...
public class DeleteLessonVideoCommand : IRequest<DeletedLessonVideoResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
    ...
    public class DeleteLessonVideoCommandHandler : IRequestHandler<DeleteLessonVideoCommand, DeletedLessonVideoResponse>
    {
        ...
        public DeleteLessonVideoCommandHandler(IMapper mapper, ILessonVideoRepository lessonVideoRepository,
        ...
        public async Task<DeletedLessonVideoResponse> Handle(DeleteLessonVideoCommand request, CancellationToken cancellationToken)
        {
