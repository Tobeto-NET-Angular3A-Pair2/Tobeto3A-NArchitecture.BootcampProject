...
public class DeleteInstructorApplicationCommand
    : IRequest<DeletedInstructorApplicationResponse>,
        ISecuredRequest,
        ILoggableRequest,
        ITransactionalRequest
{
    ...
    public class DeleteInstructorApplicationCommandHandler
        : IRequestHandler<DeleteInstructorApplicationCommand, DeletedInstructorApplicationResponse>
    {
        ...
        public DeleteInstructorApplicationCommandHandler(
            IMapper mapper,
        ...
        public async Task<DeletedInstructorApplicationResponse> Handle(
            DeleteInstructorApplicationCommand request,
        ...
        )
        {
            ...
            DeletedInstructorApplicationResponse response = _mapper.Map<DeletedInstructorApplicationResponse>(
