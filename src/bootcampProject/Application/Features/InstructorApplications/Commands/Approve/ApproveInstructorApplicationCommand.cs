...
public class ApproveInstructorApplicationCommand
    : IRequest<ApprovedInstructorApplicationResponse>,
        ISecuredRequest,
        ILoggableRequest,
        ITransactionalRequest
{
    ...
    public class ApproveInstructorApplicationCommandHandler
        : IRequestHandler<ApproveInstructorApplicationCommand, ApprovedInstructorApplicationResponse>
    {
        ...
        public ApproveInstructorApplicationCommandHandler(
            IMapper mapper,
        ...
        public async Task<ApprovedInstructorApplicationResponse> Handle(
            ApproveInstructorApplicationCommand request,
        ...
        )
        {
            ...
            ApprovedInstructorApplicationResponse response = _mapper.Map<ApprovedInstructorApplicationResponse>(
