...
public class CreateLessonContentCommand : IRequest<CreatedLessonContentResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
    ...
    public class CreateLessonContentCommandHandler : IRequestHandler<CreateLessonContentCommand, CreatedLessonContentResponse>
    {
        ...
        public CreateLessonContentCommandHandler(IMapper mapper, ILessonContentRepository lessonContentRepository,
        ...
        public async Task<CreatedLessonContentResponse> Handle(CreateLessonContentCommand request, CancellationToken cancellationToken)
        {
