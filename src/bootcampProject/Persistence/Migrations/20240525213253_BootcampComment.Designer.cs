...
namespace Persistence.Migrations
{
    ...
    [Migration("20240525213253_BootcampComment")]
    partial class BootcampComment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Setting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 5, 26, 0, 32, 51, 226, DateTimeKind.Local).AddTicks(7170),
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("65e06f38-55d1-4739-a7a0-8b1b44a7f453"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(2024, 5, 26, 0, 32, 51, 258, DateTimeKind.Local).AddTicks(1364),
                            DateOfBirth = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            FirstName = "Ays",
                            LastName = "Ayd",
                            NationalIdentity = "",
                            PasswordHash = new byte[] { 147, 176, 192, 55, 169, 130, 104, 208, 65, 39, 198, 156, 182, 19, 238, 221, 39, 56, 181, 140, 176, 34, 9, 119, 50, 161, 94, 6, 240, 135, 212, 149, 119, 150, 78, 29, 241, 177, 235, 204, 46, 90, 48, 212, 188, 4, 186, 108, 31, 123, 255, 130, 20, 254, 162, 156, 240, 220, 229, 7, 113, 15, 109, 53 },
                            PasswordSalt = new byte[] { 53, 135, 18, 249, 77, 41, 4, 163, 32, 236, 172, 155, 235, 109, 144, 52, 104, 228, 93, 102, 7, 245, 26, 107, 247, 235, 68, 122, 129, 117, 6, 80, 23, 236, 249, 148, 7, 100, 250, 60, 23, 26, 65, 119, 111, 208, 79, 22, 180, 57, 132, 235, 216, 235, 175, 42, 0, 197, 130, 86, 58, 246, 46, 130, 232, 108, 190, 71, 107, 152, 114, 9, 16, 120, 198, 114, 2, 142, 139, 190, 109, 238, 132, 190, 56, 130, 140, 68, 13, 223, 239, 134, 75, 180, 135, 187, 37, 216, 177, 156, 70, 227, 200, 80, 54, 248, 122, 177, 212, 134, 104, 12, 78, 102, 197, 50, 190, 250, 245, 94, 254, 62, 53, 84, 174, 159, 188, 30 },
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7255643e-068e-4de3-8aa1-f62184b4fd38"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("65e06f38-55d1-4739-a7a0-8b1b44a7f453")
                        });
                });
