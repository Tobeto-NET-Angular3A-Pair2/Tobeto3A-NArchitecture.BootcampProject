...
namespace Persistence.Migrations
{
    ...
    [Migration("20240430174729_AddInstructorApplication")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2b2f9850-45d7-4f60-be3e-2ed90232d0e6"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(2024, 4, 30, 20, 47, 24, 839, DateTimeKind.Local).AddTicks(7222),
                            DateOfBirth = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            FirstName = "Ays",
                            LastName = "Ayd",
                            NationalIdentity = "",
                            PasswordHash = new byte[] { 23, 123, 167, 133, 193, 116, 177, 247, 251, 146, 194, 176, 97, 96, 94, 92, 16, 234, 148, 42, 91, 163, 202, 241, 10, 175, 245, 155, 19, 40, 66, 164, 249, 113, 73, 20, 182, 29, 129, 223, 228, 225, 34, 74, 182, 210, 66, 45, 158, 188, 228, 58, 15, 87, 60, 224, 134, 96, 109, 143, 22, 13, 93, 18 },
                            PasswordSalt = new byte[] { 165, 101, 87, 46, 253, 244, 32, 85, 87, 134, 208, 113, 34, 140, 115, 136, 255, 31, 122, 164, 7, 135, 174, 154, 98, 43, 61, 70, 119, 236, 180, 88, 155, 31, 114, 47, 243, 128, 13, 82, 166, 159, 136, 92, 173, 5, 94, 252, 138, 183, 166, 244, 128, 150, 30, 149, 237, 135, 117, 227, 126, 39, 95, 161, 213, 38, 61, 128, 139, 221, 252, 140, 217, 78, 131, 23, 203, 24, 68, 130, 172, 10, 206, 117, 20, 201, 144, 148, 15, 213, 33, 201, 64, 178, 60, 215, 91, 55, 81, 67, 214, 95, 239, 74, 2, 226, 224, 22, 133, 192, 210, 46, 230, 235, 142, 122, 94, 72, 249, 95, 224, 223, 74, 46, 163, 214, 63, 189 },
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8398a7a5-4864-4959-a533-3a9ba4de000a"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("2b2f9850-45d7-4f60-be3e-2ed90232d0e6")
                        });
                });
