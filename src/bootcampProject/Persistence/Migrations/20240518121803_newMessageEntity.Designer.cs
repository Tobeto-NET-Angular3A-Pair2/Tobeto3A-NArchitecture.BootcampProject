...
namespace Persistence.Migrations
{
    ...
    [Migration("20240518121803_newMessageEntity")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fab2e156-8c52-46b3-b5fd-5f1bb980128d"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(2024, 5, 18, 15, 17, 59, 497, DateTimeKind.Local).AddTicks(5238),
                            DateOfBirth = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            FirstName = "Ays",
                            LastName = "Ayd",
                            NationalIdentity = "",
                            PasswordHash = new byte[] { 190, 27, 36, 138, 230, 58, 120, 21, 18, 142, 75, 131, 127, 234, 93, 11, 61, 11, 105, 78, 186, 170, 24, 91, 247, 203, 86, 230, 63, 163, 28, 5, 229, 50, 15, 76, 205, 177, 153, 107, 207, 18, 0, 41, 103, 111, 114, 78, 120, 222, 127, 27, 186, 134, 251, 117, 35, 161, 81, 204, 249, 47, 179, 63 },
                            PasswordSalt = new byte[] { 238, 49, 241, 98, 245, 92, 227, 146, 110, 211, 55, 39, 218, 53, 183, 227, 68, 132, 6, 208, 100, 63, 82, 237, 226, 123, 215, 186, 165, 18, 89, 203, 238, 238, 70, 29, 31, 214, 81, 219, 3, 141, 137, 3, 23, 179, 63, 150, 251, 154, 173, 174, 4, 22, 119, 102, 187, 227, 97, 52, 42, 134, 78, 138, 64, 250, 9, 188, 143, 215, 226, 139, 201, 32, 167, 116, 24, 76, 171, 19, 241, 41, 194, 133, 2, 20, 65, 220, 158, 85, 218, 157, 10, 61, 128, 165, 199, 5, 58, 185, 59, 149, 120, 79, 42, 116, 84, 89, 224, 147, 136, 151, 211, 251, 148, 55, 213, 215, 112, 130, 76, 48, 1, 112, 161, 174, 17, 1 },
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("85142f4b-045a-43a0-8b9a-5a141def5c47"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("fab2e156-8c52-46b3-b5fd-5f1bb980128d")
                        });
                });
