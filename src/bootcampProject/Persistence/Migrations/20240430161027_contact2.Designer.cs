...
namespace Persistence.Migrations
{
    ...
    [Migration("20240430161027_contact2")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b3529d77-978b-4d77-8906-4a5e30b173c4"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(2024, 4, 30, 19, 10, 26, 851, DateTimeKind.Local).AddTicks(2768),
                            DateOfBirth = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            FirstName = "Ays",
                            LastName = "Ayd",
                            NationalIdentity = "",
                            PasswordHash = new byte[] { 212, 59, 200, 2, 53, 74, 225, 12, 248, 183, 101, 85, 105, 254, 114, 187, 175, 207, 57, 31, 175, 101, 139, 177, 134, 210, 164, 24, 110, 154, 223, 215, 196, 248, 135, 11, 88, 220, 162, 29, 124, 110, 28, 209, 96, 99, 238, 208, 242, 39, 37, 3, 59, 206, 246, 227, 87, 168, 255, 34, 146, 246, 223, 129 },
                            PasswordSalt = new byte[] { 210, 222, 210, 41, 183, 224, 28, 232, 191, 114, 225, 247, 8, 132, 250, 73, 91, 150, 70, 80, 127, 250, 222, 2, 173, 193, 70, 207, 102, 144, 130, 249, 225, 91, 204, 73, 179, 190, 60, 224, 144, 144, 49, 103, 214, 138, 16, 112, 234, 95, 172, 225, 185, 186, 24, 244, 139, 196, 41, 92, 35, 137, 255, 69, 215, 75, 62, 79, 202, 146, 129, 51, 227, 39, 65, 13, 134, 32, 244, 139, 237, 133, 15, 221, 238, 78, 133, 240, 97, 48, 197, 180, 220, 26, 159, 50, 133, 3, 93, 191, 100, 206, 208, 4, 125, 93, 74, 176, 152, 179, 225, 13, 240, 213, 29, 125, 75, 86, 81, 15, 250, 119, 0, 211, 250, 53, 253, 29 },
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("02968bac-25ce-4153-ab74-97537a577349"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("b3529d77-978b-4d77-8906-4a5e30b173c4")
                        });
                });
